...
public class MockLimbusSystem implements IInitializable<Exception> {
   ...
   * @see org.max5.limbus.system.LimbusSystem#getInfoRecords()
   */
  ...
  /**
   * @see org.max5.limbus.system.LimbusSystem#logLimbusSystemInformation()
   */
   ...
   * @return Returns this object for method chaining.
   * @see org.max5.limbus.system.LimbusSystem#addComponentConfiguration(java.lang.Class, java.lang.Class)
   */
