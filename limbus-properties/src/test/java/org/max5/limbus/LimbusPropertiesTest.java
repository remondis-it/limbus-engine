...
public class LimbusPropertiesTest {
  ...
  public void test_no_override() throws Exception {
    ...
    filesystem.addClasspathContent(getClass(), LimbusFileService.CONFIG_DIRECTORY,
        "/org.max5.limbus.LimbusPropertiesTest_default.properties");
    filesystem.addContent(
        filesystem.toPath(LimbusFileService.CONFIG_DIRECTORY, "org.max5.limbus.LimbusPropertiesTest.properties"),
        new byte[] {});
  ...
  public void test_override() throws Exception {
    ...
    filesystem.addClasspathContent(getClass(), LimbusFileService.CONFIG_DIRECTORY,
        "/org.max5.limbus.LimbusPropertiesTest_default.properties");
    filesystem.addClasspathContent(getClass(), LimbusFileService.CONFIG_DIRECTORY,
        "/org.max5.limbus.LimbusPropertiesTest.properties");
