...
import org.max5.limbus.launcher.EngineUtil;
import org.max5.limbus.launcher.SystemEngine;
...
public class EngineShowcaseLauncher {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      deployService.deployMavenArtifact("org.max5.limbus", "limbus-showcase-plugin", null, version, permissions);
      // Find the plugin's classpath which identifies the plugin.
      String deployName = deployService.toDeployName("org.max5.limbus", "limbus-showcase-plugin", null, version);
