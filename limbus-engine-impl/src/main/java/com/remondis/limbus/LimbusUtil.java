...
public final class LimbusUtil {
  ...
  public static final String PUBLIC_LIMBUS_API_PACKAGE_PREFIX = LimbusEngineImpl.class.getPackage()
      .getName();
   ...
   */
  static final List<String> getDefaultAllowedPackagePrefixes() {
