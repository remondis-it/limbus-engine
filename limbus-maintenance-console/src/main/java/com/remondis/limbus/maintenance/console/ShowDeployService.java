...
public class ShowDeployService extends AbstractLimbusItem {
  ...
  private void createUndeployActionList(final ActionListBox undeployList, final LimbusMaintenanceConsole console) {
    ...
    // buschmann - 04.05.2017 : Note: Only classpaths deployed by the Deploy Service
    // can be undeployed via maintanance
    // console. It would make sense to provide more undeployable classpaths here
    // using
          ...
          try {
            ...
            if (Lang.isEmpty(groupId) || Lang.isEmpty(artifactId) || Lang.isEmpty(version)) {
              ...
              if (engine.hasClasspath(deployName)) {
                ...
                // TODO - schuettec - 14.10.2016 : Only sandbox default permissions are granted
                // for plugins deployed by
  ...
  // }
  //
  // private void addDirectoryInfo(String label, Callable<File> directoryProvider,
  // Panel panel) {
  // try {
