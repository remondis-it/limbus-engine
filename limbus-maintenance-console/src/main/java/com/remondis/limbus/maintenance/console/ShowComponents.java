...
/**
 * This maintenance page shows information of the modules included in the
 * running Limbus Engine. The classpath is analyzed using the classloader that
...
public class ShowComponents extends AbstractLimbusItem {
   ...
   * (non-Javadoc)
   *
   * @see com.remondis.limbus.maintenance.Action#getComponent(com.remondis.limbus.
   * LimbusMaintenanceConsole)
   */
  @Override
