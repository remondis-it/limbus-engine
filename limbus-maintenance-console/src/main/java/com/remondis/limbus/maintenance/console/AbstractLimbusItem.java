 ...
 * in {@link LimbusMaintenanceConsole} and <b>add the item to the maintenance
 * console root category</b>. All basic Limbus Maintenance features are added
 * into the root category..
 *
 * @author schuettec
 *
 */
