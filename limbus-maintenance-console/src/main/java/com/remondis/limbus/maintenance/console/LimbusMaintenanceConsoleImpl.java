...
public class LimbusMaintenanceConsoleImpl extends Initializable<Exception> implements LimbusMaintenanceConsole {
  ...
  private void showWelcomePanel() {
    ...
    welcomeText.addLine("");
    welcomeText.addLine("The currently running Limbus Engine version is: " + engine.getEngineVersion());
  ...
  /**
   * <p>
   * <b>Note: Operations on the GUI object must be done in the Lanterna GUI
   * Thread!!</b>
   * </p>
   *
  ...
  protected void performInitialize() throws Exception {
    // We have to wait until the console thread has reached addWindowAndWait. If we
    // return earlier from this method, a
    ...
    this.consoleThread = new Thread(new Runnable() {
      ...
      public void run() {
        try {
          ...
          Label versionLabel = new Label(String.format(VERSION_FORMAT, engine.getEngineVersion()));
